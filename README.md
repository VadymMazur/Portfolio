...
## 👤 About Me
* **Specialization:** Web (GUI/API) and Mobile application testing (Android/iOS).
* **Expertise:** Deep understanding of SDLC/STLC, test documentation design, database validation, and performance testing basics.
* **Goal:** To provide transparent documentation and detailed reports that help development teams achieve Quality Gates faster.

---

## 📂 Portfolio Structure

Below are the repository folders organized by key QA artifacts:

| Folder | Content Description | Key Skills / Tools |
| :--- | :--- | :--- |
| [**`Test_Plan`**](./Test_Plan) | Testing strategies, scope, risks, and exit criteria. | Test Strategy, Planning, Resource Management |
| [**`Test_Cases`**](./Test_Cases) | Detailed cases for Functional, Security, and Regression testing. | Test Design (BVA, EP, Decision Tables, State Transition) |
| [**`Checklists`**](./Checklists) | High-level checklists for Smoke, Sanity, and UI/UX verification. | UI/UX Verification, Heuristic Analysis |
...
* **Management & Tracking:** Jira, Azure DevOps, TestRail.
* **Web & Mobile Testing:** Chrome DevTools, Android Studio (Emulator), iOS (Simulator).
* **API Testing:** Postman, SoapUI.
* **Databases:** SQL (PostgreSQL, MySQL).
* **Version Control:** Git (CLI, GitHub).
* **Performance:** Apache JMeter.
* **Automation (Intro):** Selenium WebDriver.
